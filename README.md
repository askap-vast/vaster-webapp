# YWang VASTER Transient Classification Tool

This web application is made in Python 3.14, Django v6.0, Bootstrap v5.3 and uses a Postgres v16 (with Q3C) backend to store all of the site and uploaded data.
